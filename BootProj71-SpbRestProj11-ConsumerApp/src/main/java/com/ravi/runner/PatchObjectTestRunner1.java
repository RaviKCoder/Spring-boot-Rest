...
public class PatchObjectTestRunner1 implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		//base url
		String url="http://localhost:8082/BootProj70-SpbRestProj10-APIDevelopment-MiniProject-Swagger/traveller-api/update/{tid}/{discount}";

		//register the factory
		template.setRequestFactory(new HttpComponentsClientHttpRequestFactory());
		
		//invoke the endpoint
		ResponseEntity<String> resp = template.exchange(url, HttpMethod.PATCH, null, String.class,1023
				,10.0);
